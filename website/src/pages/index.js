          ...
          <div className="col-lg-8 offset-lg-2 col-xs-12">
            <div className="row align-items-center" style={{ marginTop: 72 }}>
              ...
              >
                ...
                <Paragraph style={{ marginTop: 8 }}>
                  We strongly believe in the principles of open-source and
                  shared contributions. Everyone eating at the buffet is
                  welcomed to contribute as well.
                </Paragraph>
              </div>
            </div>
            ...
            <div className="row align-items-center" style={{ marginTop: 84 }}>
              ...
              >
                ...
                <Paragraph style={{ marginTop: 8 }}>
                  Created with the community in mind, Buffet is made by
                  developers for developers. It is fully supported by its
                  creators (and by open-source contributors).
                </Paragraph>
              </div>
            </div>
          </div>
