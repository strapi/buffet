  ...
  <Layout>
    ...
    >
      ...
      <div className="row home_main_cta">
        <div className="col-lg-12 col-xs-12" style={{ paddingTop: 40, textAlign: 'center' }}>
      ...
      <div className="row home_philosophy">
        ...
        <div className="col-lg-8 offset-lg-2 col-xs-12">
          <div className="row align-items-center" style={{ marginTop: 72 }}>
            <div className="col-lg-4 col-xs-12" style={{ paddingLeft: 'calc(36px + 15px)' }}>
              <img style={{ width: 160, height: 160 }} src={IconOpenSource} alt="Open source icon" />
            </div>
            <div className="col-lg-8 col-xs-12" style={{ paddingLeft: 'calc(36px + 15px)' }}>
              <h3
          ...
          <div className="row align-items-center" style={{ marginTop: 84 }}>
            ...
            <div className="col-lg-5 col-xs-12 order-1 order-lg-2" style={{ paddingRight: 'calc(36px + 15px)', textAlign: 'right' }}>
              <img style={{ width: 160, height: 160 }} src={IconConsistent} alt="Consistent icon" />
            </div>
          </div>
          <div className="row align-items-center" style={{ marginTop: 84 }}>
            <div className="col-lg-4 col-xs-12" style={{ paddingLeft: 'calc(36px + 15px)' }}>
              <img style={{ width: 160, height: 160 }} src={IconCommunity} alt="Community icon" />
            </div>
            <div className="col-lg-8 col-xs-12" style={{ paddingLeft: 'calc(36px + 15px)' }}>
              <h3
                className="home_philosophy_section_title"
